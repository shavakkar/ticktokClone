...
<template>
  <div
    id="TopNav"
    class="fixed bg-white z-30 flex items-center justify-between w-full border-b h-[61px]"
  >
    <div
    ...
    >
      ...
      >
        <input
          type="text"
          class="w-full pl-3 py-2 bg-transparent placeholder-[#838383] text-[15px] focus:outline-none"
