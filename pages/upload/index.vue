<template>
  ...
  <div
    v-if="isUploading"
    class="fixed flex items-center justify-center top-0 left-0 w-full h-screen text-black z-50 bg-opacity-50"
  >
    <Icon
    ...
    >
      ...
      <div class="mt-8 md:flex gap-6">
        ...
        >
          ...
          <div
            class="px-2 py-1.5 mt-8 text-white text-[15px] w-[80%] bg-[#f02c65] rounded-sm"
          >
            Select File
          </div>
          <input
